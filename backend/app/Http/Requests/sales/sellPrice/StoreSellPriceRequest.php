...
class StoreSellPriceRequest extends FormRequest
{
            ...
            'product_id' => [
                ...
                function ($attribute, $value, $fail) {
                    if ($this->has('start_date') && $this->has('end_date')) {
                        ...
                        if ($hasOverlap) {
                            $fail('An active price already exists for this product in the given date range.');
                        }
                    }
                }
            ],
            'sell_price' => 'required|numeric|min:0',
            'market_price' => 'required|numeric|min:0|gte:sell_price',

...
export const useUnitColumns = ({
  ...
  formatDate,
  status,
}: UseUnitColumnsProps): ColumnDef<Unit>[] => {
  return useMemo((): ColumnDef<Unit>[] => [
    {
      id: "sl",
      header: "SL",
      enableSorting: false,
        ...
        return (
          <ActionButtons
            ...
            buttons={[
              {
                icon: FiEye,
                onClick: (row) => onView(row as Unit),
                variant: "success",
                size: "sm",
                tooltip: "View",
                show: () => hasPermission("unit.view"),
              },
              {
                icon: FiEdit,
                onClick: (row) => onEdit(row as Unit),
                variant: "primary",
                size: "sm",
                tooltip: "Edit",
                show: () => hasPermission("unit.edit"),
              },
              {
                icon: FiTrash,
                onClick: (row) => handleSoftDelete((row as Unit).id),
                variant: "danger",
                size: "sm",
                tooltip: "Move to Trash",
                show: () => hasPermission("unit.delete"),
              },
            ]}
          />
        );

...
export const useBrandColumns = ({
  ...
  formatDate,
  status,
}: UseBrandColumnsProps): ColumnDef<Brand>[] => {
        ...
        return (
          <ActionButtons
            ...
            buttons={[
              {
                icon: FiEye,
                onClick: (row) => onView(row as Brand),
                variant: "success",
                size: "sm",
                tooltip: "View",
                show: () => hasPermission("brand.view"),
              },
              {
                icon: FiEdit,
                onClick: (row) => onEdit(row as Brand),
                variant: "primary",
                size: "sm",
                tooltip: "Edit",
                show: () => hasPermission("brand.edit"),
              },
              {
                icon: FiTrash,
                onClick: (row) => handleSoftDelete((row as Brand).id),
                variant: "danger",
                size: "sm",
                tooltip: "Move to Trash",
                show: () => hasPermission("brand.delete"),
              },
            ]}
          />
        );

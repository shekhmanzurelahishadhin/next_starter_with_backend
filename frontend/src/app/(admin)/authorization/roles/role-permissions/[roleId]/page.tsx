...
import { useRolePermissions } from "@/app/(admin)/authorization/roles/hooks/useRolePermissions";
import Checkbox from "@/components/form/input/Checkbox";
import ReactSelect from "@/components/form/ReactSelect";
import Badge from "@/components/ui/badge/Badge";
import ComponentCard from "@/components/common/ComponentCard";
import AccessRoute from "@/routes/AccessRoute";
import RolePermissionsSkeleton from "@/components/ui/skeleton/RolePermissionsSkeleton";
...
const RolePermissionsPage = () => {
  ...
  const breadcrumbItems = [
    { title: "Roles", href: "/authorization/roles" },
    ...
    <AccessRoute requiredPermissions={["role.assign-permissions"]}>
      <div className="space-y-6">
        ...
        <ComponentCard 
          ...
          desc="Manage and assign permissions to this role"
          className="border-t-4 border-t-blue-500"
        >
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <FiLayers className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                  Select Permissions
                </h2>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Manage permissions for the <span className="font-medium text-blue-600 dark:text-blue-400">{role?.name}</span> role. 
